                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-0 justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                            <button onClick={()=>setIsPreviewMode(false)} className={`px-3 py-2 text-sm font-medium transition-colors ${!isPreviewMode ? 'bg-violet-50 text-violet-700 border-r border-violet-200': 'text-gray-600 hover:bg-gray-50'}`}>Edit</button>
                            <button
