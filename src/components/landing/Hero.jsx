...
<div className="text-sm text-gray-600">Avg, Creation</div>
            ...
            <div className="relative lg:pl-8 ">
                <div className="relative">
                    ...
                    <div className="absolute bottom-6 left-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-from-left guration-700 delay-300">
                        <div className="flex items-center space-x-3">
