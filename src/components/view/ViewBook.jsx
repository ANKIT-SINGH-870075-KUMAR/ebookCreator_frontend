...
const ViewBook = ({book}) => {
    ...
    const formatContent = (content) => {
        return content
        .split('\n\n').filter(paragraph => paragraph.trim()).map(paragraph => paragraph.trim()).map(paragraph => paragraph.trim()).map(paragraph => {
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="max-w-4xl mx-auto px-6 py-12">
              ...
              <div className="flex justify-between items-center mt-16 pt-8 border-t border-gray-200">
                <button
                 onClick={()=> selectedChapterIndex(Math.max(0, selectedChapterIndex - 1))}
